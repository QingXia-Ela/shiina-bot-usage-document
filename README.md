...
- `#bili listen [room_id]` 开启该直播间直播监听
- `#bili unlisten [room_id]` 关闭该直播间直播监听
- `#bili help` 查看帮助

举例：`#bili listen 5555734` 可以开启直播间监听

room_id 获取方法

- 在浏览器打开你想要监听主播的直播间
- 然后看地址栏，类似这种：https://live.bilibili.com/1646070，后面如果有带个 `?` 号的可以直接忽略
- 地址栏那一串数字就是直播间 id，假如我想要订阅以上直播间开播通知，我就可以这样子发送指令：`#bili listen 1646070`
